...
* **Customizable**: Control node colors, shapes, edge styles (solid/dashed), and coefficients. Rename nodes if necessary.
...
* You can **rename a node** by typing its original name in the `Node Name` field and clicking on `Rename Node` button.
